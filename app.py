...
st.set_page_config(page_title="RNC App v09-min (no-supabase)", page_icon="📝", layout="wide")
...
def read_text():
    ...
    if os.path.exists(LOCAL_DATA):
        return open(LOCAL_DATA, "r", encoding="utf-8").read()
    return None
...
if menu == "➕ Nova RNC":
    ...
    st.write("Armazenamento: LOCAL (.rnc_data) — variante sem Supabase")
